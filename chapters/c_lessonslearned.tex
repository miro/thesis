...
The points presented in the \textit{design guidelines} section are factors that are recommendations for developing similar functionalities into other single-page applications.

The discussion section contains speculation on points detected during the development and deployment of the offline support, but which were too vague for basing any recommendations on. 
