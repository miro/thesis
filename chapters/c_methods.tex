...
The structure used on the Päikky nurses' interviews can be found from the appendix A <hox todo viittaus liitteeseen>. % The structure on the client organization CEO's interview can be found from the appendix B <hox todo viittaus liitteeseen>. POISTETTU toistaiseksi, ei tuosta liitteestä suurta käytännön hyötyä tulisi
