...
Conceptual integrity in automotive manufacturing is pursued by using existing parts and integrated problem solving.  % SIVU 137

% LSD: design cycles, right the first time, cycles involving business

% Conceptual integrity
% Automotive -> effectiveness of communication mechanisms
% Usage of existing parts
