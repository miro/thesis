...
% Manual or automatic. Automatic -> increasing frequencies
% Static analysis and Code inspections synergistic

% Glass box
% > 85% of waterfall
% > 80% of defect repairs
% 25%-55%, avg 35%
% High levels of cyclomatic complexity can reduce
